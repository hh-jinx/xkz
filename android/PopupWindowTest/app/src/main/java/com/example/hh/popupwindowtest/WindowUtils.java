...
//        mContext = context.getApplicationContext();
    ...
    private static View setUpView(final Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.pop_show, null);

        ImageView iv_close_pop = (ImageView) view.findViewById(R.id.iv_pop_close);
